 ...
 * @author aksha
 */
public class JFrame_AdmissionAdmin extends javax.swing.JFrame {
    ...
    public JFrame_AdmissionAdmin(City_List city_list_i, Community_List community_list_i, House_List house_list_i, Hospital_List hospital_list_i, Encounter_History encounter_history_i, Person_List person_list_i) {
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        JPanel_student_Id_AdmissionAdmin a = new JPanel_student_Id_AdmissionAdmin ();
        jSplitPane1.setRightComponent(a);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_AdmissionAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_AdmissionAdmin().setVisible(true);
            }
        });
    }
