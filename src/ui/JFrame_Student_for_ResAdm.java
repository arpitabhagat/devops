 ...
 * @author aksha
 */
public class JFrame_Student_for_ResAdm extends javax.swing.JFrame {
     ...
     */
    public JFrame_Student_for_ResAdm(City_List city_list_i, Community_List community_list_i, House_List house_list_i, Hospital_List hospital_list_i, Encounter_History encounter_history_i, Person_List person_list_i) {
    ...
    public JFrame_Student_for_ResAdm() {
    ...
    private void initComponents() {
        ...
        workPanel.setPreferredSize(new java.awt.Dimension(1130, 677));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JFrame_ResAdmin s = new JFrame_ResAdmin();
        s.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_Student_for_ResAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_Student_for_ResAdm().setVisible(true);
            }
        });
    }
