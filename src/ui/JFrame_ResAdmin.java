 ...
 * @author aksha
 */
public class JFrame_ResAdmin extends javax.swing.JFrame {
    ...
    public JFrame_ResAdmin(City_List city_list_i, Community_List community_list_i, House_List house_list_i, Hospital_List hospital_list_i, Encounter_History encounter_history_i, Person_List person_list_i) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButton6.setText("Residential Department");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        JPanel_student_Id_ResAdmin a = new JPanel_student_Id_ResAdmin ();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrame_ResAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrame_ResAdmin().setVisible(true);
            }
        });
    }
